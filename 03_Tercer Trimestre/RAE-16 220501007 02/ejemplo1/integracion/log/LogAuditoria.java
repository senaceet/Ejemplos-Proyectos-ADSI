...
@NamedQueries({
    ...
    @NamedQuery(name = "LogAuditoria.findByLogName", query = "SELECT l FROM LogAuditoria l WHERE l.logName like :logName"),
    @NamedQuery(name = "LogAuditoria.findByMensaje", query = "SELECT l FROM LogAuditoria l WHERE l.mensaje like :mensaje"),
    @NamedQuery(name = "LogAuditoria.findByUsuario", query = "SELECT l FROM LogAuditoria l WHERE l.usuario like :usuario"),
    @NamedQuery(name = "LogAuditoria.findByFecha", query = "SELECT l FROM LogAuditoria l WHERE l.fecha BETWEEN :fechaInicial and :fechaFinal")})
public class LogAuditoria implements Serializable {
     ...
     * @param fecha
     */
    public LogAuditoria(String nivel, String logName, String mensaje, String usuario, Date fecha) {
        this.nivel = nivel;
